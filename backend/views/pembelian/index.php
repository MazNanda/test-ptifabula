        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=pembelian/view&id=' . $model->id_pembelian;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=pembelian/update&id=' . $model->id_pembelian;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=pembelian/delete&id=' . $model->id_pembelian;
                        return $url;
                    }
                }
            ],
