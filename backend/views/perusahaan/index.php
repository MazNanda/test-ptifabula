...
<div class="perusahaan-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=perusahaan/view&id=' . $model->id_perusahaan;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=perusahaan/update&id=' . $model->id_perusahaan;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=perusahaan/delete&id=' . $model->id_perusahaan;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="fa fa-box"></span> Daftar Perusahaan',
        ],
        'persistResize' => false,
