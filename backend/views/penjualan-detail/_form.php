        ...
        <div class="panel-body">
            <div class="col-md-12" style="padding: 0;">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <?= $form->field($model, 'id_penjualan')->HiddenInput()->label(false) ?>
                            ...
                            <div class="form-group">
                                <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Kembali', ['penjualan/view', 'id' => $model->id_penjualan], ['class' => 'btn btn-warning']) ?>
