        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    if ($model->tanggal_penjualan != null) {
                        # code...
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=penjualan/view&id=' . $model->id_penjualan;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=penjualan/update&id=' . $model->id_penjualan;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=penjualan/delete&id=' . $model->id_penjualan;
                        return $url;
                    }
                }
            ],
